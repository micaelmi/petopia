            ...
            <fieldset class="registros">
                ...
                ?>
                    <div class="registro">
                        ...
                        <button
                            onclick="openModal(<?=$registro['id_vendedor']?>)"
                            title="Editar"
                        ...
                        <button
                            onclick="deleteData('delete.php?codigo=<?=$registro['id_vendedor']?>')"
                            title="Apagar"
                            style="all: initial; cursor: pointer;"
                        >
                        ...
                        <div class="content">
                            <form class="insert" action="edit.php?codigo=<?=$registro['id_vendedor']?>" method="POST">
                                <div class="input_edit">
                                    <input type="text" name="cpf_cnpj" id="cpf_cnpj" value="<?=$registro['cpf_cnpj_vendedor']?>">
                                    <input type="text" name="nome" id="nome" value="<?=$registro['nm_vendedor']?>">
