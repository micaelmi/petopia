            ...
            <fieldset class="registros">
                ...
                ?>
                    <div class="registro">
                        ...
                        <button
                            onclick="openModal(<?=$registro['id_categoria']?>)"
                            title="Editar"
                        ...
                        <button
                            onclick="deleteData('delete.php?codigo=<?=$registro['id_categoria']?>&ptcod=1')"
                            title="Apagar"
                            style="all: initial; cursor: pointer;"
                        >
                        ...
                        <div class="content">
                            <form class="insert" action="edit.php?codigo=<?=$registro['id_categoria']?>&ptcod=1" method="POST">
                                <div class="input_edit">
                                    <input type="text" name="descricao" id="descricao" value="<?=$registro['ds_categoria']?>">
            ...
            <fieldset class="registros">
                ...
                ?>
                    <div class="registro">
                        ...
                        <button
                            onclick="openModal(<?=$registro['id_unidade_medida']?>)"
                            title="Editar"
                            style="all: initial; cursor: pointer"
                        >
                            <img src="../../img/edit.svg" alt="Editar">
                        ...
                        <button
                            onclick="deleteData('delete.php?codigo=<?=$registro['id_unidade_medida']?>&ptcod=2')"
                            title="Apagar"
                            style="all: initial; cursor: pointer;"
                        >
                            <img src="../../img/delete.svg" alt="Deletar">
                    ...
                    <div class="modal" id="<?=$registro['id_unidade_medida']?>">
                        <button class="button_cancel" onclick="closeModal(<?=$registro['id_unidade_medida']?>)">X | Cancelar</button>
                        <div class="content">
                            <form class="insert" action="edit.php?codigo=<?=$registro['id_unidade_medida']?>&ptcod=2" method="POST">
                                <div class="input_edit">
                                    <input type="text" name="sigla" id="sigla" value="<?=$registro['sg_unidade_medida']?>">
                                    <input type="text" name="descricao" id="descricao" value="<?=$registro['ds_unidade_medida']?>">
                                    <button type="submit">Salvar edição</button>
                                </div>
                            </form>
                        </div>
