    ...
    ?>
      ...
      ?>
        ...
        <div class="produto">
          ...
          <div class="imagens">
            <img src="<?=loadCadastrado("../../img/produtos/" . $registro['nm_produto'] . $registro['dimensoes_produto'] . "1.png") ?>" alt="" />
            <img src="<?= loadCadastrado("../../img/produtos/" . $registro['nm_produto'] . $registro['dimensoes_produto'] . "2.png") ?>" alt="" />
            <img src="<?= loadCadastrado("../../img/produtos/" . $registro['nm_produto'] . $registro['dimensoes_produto'] . "3.png") ?>" alt="" />
            <img src="<?= loadCadastrado("../../img/produtos/" . $registro['nm_produto'] . $registro['dimensoes_produto'] . "4.png") ?>" alt="" />
            <img src="<?= loadCadastrado("../../img/produtos/" . $registro['nm_produto'] . $registro['dimensoes_produto'] . "5.png") ?>" alt="" />
          </div>
        </div>
        ...
        <div class="modal" id="<?= $registro['id_produto'] ?>">
          <div class="total_content">
            ...
            <div class="content">
              <form
                class="insert"
                action="edit.php?codigo=<?= $registro['id_produto'] ?>"
